...
class TestDbCacheSettings:
    def test_cachalot_default_settings(self):
        ...
        assert cachalot_settings["CACHALOT_QUERY_KEYGEN"] == "paperless.db_cache.custom_get_query_cache_key"
    ...
    def test_cachalot_custom_settings(self):
        ...
        assert settings["CACHALOT_QUERY_KEYGEN"] == "paperless.db_cache.custom_get_query_cache_key"
        assert settings["CACHALOT_TABLE_KEYGEN"] == "paperless.db_cache.custom_get_table_cache_key"
